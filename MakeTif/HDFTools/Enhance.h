...
namespace HDFTools
{
	...
	protected:
		...
		//
	public:
		static void Histogram_Equalization_IgnoreZero(uchar *src,int width,int height);
		static void Histogram_Equalization_IgnoreZero(ushort *src,int width,int height);
	};
}
